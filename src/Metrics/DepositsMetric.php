...
class DepositsMetric extends AbstractMetric
{
    ...
    {
        return 'Calculates the total completed deposit amounts over a period of time.';
    }
    ...
    public function execute(array $filters = []): mixed
    {
        ...
        return [
            'value' => $this->service->getDeposits($from, $to),
